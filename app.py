...
laptoptype = st.selectbox('Type', data['TypeName'].unique())
...
screen_size = st.selectbox('Screen Size', [13.3, 15.6, 15.4, 14.0 , 12.0 , 11.6, 17.3, 10.1, 13.5, 12.5, 13.0 ,
       18.4, 13.9, 12.3, 17.0 , 15.0 , 14.1, 11.3])
...
if st.button('Predict Price'):
    ...
    query = np.array([company, laptoptype, ram, os, weight,
    ...
    st.title("Predicted price for this laptop could be between Rs." +
             str(prediction-1000) + " to Rs." + str(prediction+1000))
